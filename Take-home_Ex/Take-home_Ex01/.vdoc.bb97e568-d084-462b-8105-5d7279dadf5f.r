...
Pathum_Thani_owin <- spatstat.geom::rescale(Pathum_Thani_owin, 1000, "km")
Samut_Prakan_owin <- spatstat.geom::rescale(Samut_Prakan_owin, 1000, "km")
Nakhon_Pathom_owin <- spatstat.geom::rescale(Nakhon_Pathom_owin, 1000, "km")
