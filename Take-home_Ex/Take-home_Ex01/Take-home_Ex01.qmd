...
bmr_adm_boundary <- read_rds("../../data/takehome01/bmr_adm_boundary.rds")
bmr_primary_roads <- read_rds("../../data/takehome01/bmr_primary_roads.rds")
bmr_acc_sf <- read_csv("../../data/takehome01/bmr_road_traffic_accidents_2019-2022.rds")
...
Description of the distribution of accidents by month in the Bangkok Metropolitan Region. The bar plot below shows the number of accidents for each month, highlighting any seasonal trends or patterns in the Bangkok Metropolitan Region.
...
The newyear holiday period may influence the number of accidents, as people tend to travel more during this time. The term "seven dangerous days" (Apr 11 to Apr 17) is often used in Thailand to describe the period around the New Year when traffic accidents are more frequent. Below is the plot to compare average daily accidents during the New Year holiday period with other times of the year for 4 year from 2019 to 2022 for each year.
